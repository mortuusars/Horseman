package io.github.mortuusars.horseman.test;

import com.mojang.datafixers.util.Pair;
import io.github.mortuusars.horseman.Horseman;
import io.github.mortuusars.horseman.test.framework.Test;
import io.github.mortuusars.horseman.test.framework.TestResult;
import io.github.mortuusars.horseman.test.framework.TestingResult;
...
public class Tests {
    ...
    public TestingResult run() {
        Horseman.LOGGER.info("RUNNING TESTS");
        ...
        Horseman.LOGGER.info(String.join("",
                "TESTS COMPLETED!\n",
